...
Для блогов [А—К](#a-k) и [B.SP](#bsp) всем внешним ссылкам обязательно указывать атрибуты `rel="nofollow"` и `target="_blank"`. Для рассылки используется только `target="_blank"`.
